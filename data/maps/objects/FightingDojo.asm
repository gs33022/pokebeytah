...
FightingDojo_Object:
	...
	def_object_events
	object_event  5,  3, SPRITE_KOGA, STAY, DOWN, 1, OPP_BLACKBELT, TEXT_FIGHTINGDOJO_KARATE_MASTER
	object_event  3,  4, SPRITE_KOGA, STAY, RIGHT, 2, OPP_BLACKBELT, TEXT_FIGHTINGDOJO_BLACKBELT1
	object_event  3,  6, SPRITE_KOGA, STAY, RIGHT, 3, OPP_BLACKBELT, TEXT_FIGHTINGDOJO_BLACKBELT2
	object_event  5,  5, SPRITE_KOGA, STAY, LEFT, 4, OPP_BLACKBELT, TEXT_FIGHTINGDOJO_BLACKBELT3
	object_event  5,  7, SPRITE_KOGA, STAY, LEFT, 5, OPP_BLACKBELT, TEXT_FIGHTINGDOJO_BLACKBELT4
