...
; Route 3
	...
	db 14, RATTATA, RATTATA, PIKACHU, 0
	db 10, JIGGLYPUFF, JIGGLYPUFF, 0
; Route 4
...
; Route 17
	...
	db 28, HITMONCHAN, PONYTA, 0
	db 33, KOFFING, PONYTA, 0
	db 29, VOLTORB, PRIMEAPE, 0
	db 29, KOFFING, GRIMER, 0
	db 25, HITMONLEE, PONYTA, 0
; Route 14
...
; Cinnabar Gym
	db 36, MAGMAR, NINETALES, RAPIDASH, 0
...
; Rocket Hideout B1F
	...
	db 19, RATTATA, RATICATE, GAVILLAIN, RATTATA, 0
...
LtSurgeData:
	db $FF, 22, TYKER, 23, PIKACHU, 24, ELECTABUZZ, 0
