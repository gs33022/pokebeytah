...
_KadabraDexEntry::
	text "One person won"
	next "a contest with a"
	next "story about a boy"
...
_VaporeonDexEntry::
	...
	page "water molecule."
	next "It can invisibly"
	next "melt into water"
	dex
...
_PidgeottoDexEntry::
	...
	next "EGGSTREME to its"
	next "nest 60 mi away"
	dex
