...
INCLUDE "data/maps/headers/ShadyShopMtMoon.asm"
INCLUDE "scripts/ShadyShopMtMoon.asm"
INCLUDE "data/maps/objects/ShadyShopMtMoon.asm"
ShadyShopMtMoon_Blocks: INCBIN "maps/ShadyShopMtMoon.blk"
